    ...
    keybindings =
      {
        ...
        "super + shift + {space, s, e, d, p, z, c, g, b, w}" = "{rofi -show drun, powermenu, egmenu, smenu, pmenu --type, emoji-menu, cmenu, github-menu, changelog-menu, wifimenu}";
        "super + ctrl + alt + shift + {space, s, e, d, p, z, c, g, b, w}" = "{rofi -show drun, powermenu, egmenu, smenu, pmenu --type, emoji-menu, cmenu, github-menu, changelog-menu, wifimenu}";
