    ...
    keybindings =
      {
        ...
        "super + shift + {space, s, e, d, p, z, c, g, b}" = "{rofi -show drun, powermenu, egmenu, smenu, pmenu --type, emoji-menu, camp-menu, github-menu, changelog-menu}";
        "super + ctrl + alt + shift + {space, s, e, d, p, z, c, g, b}" = "{rofi -show drun, powermenu, egmenu, smenu, pmenu --type, emoji-menu, camp-menu, github-menu, changelog-menu}";
